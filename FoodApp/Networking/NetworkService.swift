...
struct NetworkService {
    ...
    private func request<T: Codable>(route: Route,
        ...
        guard let request = createRequest(route: route, method: method, parameters: parameters)
        else{
    ...
    ///   - method: type of request to be made eg GET/POST
    ///   - parameters: whatever extra info you need to pass to the backend
    /// - Returns: URLRequest
    ///
